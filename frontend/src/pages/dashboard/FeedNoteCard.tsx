...
function FeedNoteEngagement({ setUpvoteCount, note }: { setUpvoteCount: [any, any], note: FeedNoteObject }) {
  ...
  return (
    <div className="note-engagement">
      ...
      <Link className="cmnt-engagement" to={`/post/${note.noteData.noteID}`} style={{textDecoration: "none"}}>
        <svg
          width="24"
          height="24"
          viewBox="0 0 24 24"

...
export function NoteEngagement({ upvote, upvoteCount, isQuickPost, controller: [upvoteManage], postID }: any) {
    ...
    return (
        <>
            ...
            <ShareModal showState={[shareModalShow, setShareModalShow]} noteLink={`/post/${postID}`}></ShareModal>
        </>
    )
}
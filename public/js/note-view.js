...
const imgTemplate =
  "https://fakeimg.pl/600x600/ebebeb/000000?text=User&font=bebas";
const templateName = "Robot Dude";
const templateDate = "December 10, 2024 at 08:30 AM";
...
const postMainComment = () => {
  ...
  if (commentHTML) {
    // Template for main comment
    const mainCommentTemplate = `
            ...
            <div class="main__cmnts-replies-wrapper">
              <div class="main__body cmnt-body-3rows">
                <div class="main__reply-info reply-info">
                  ...
                  <span class="reply-date">${templateDate}</span>
                </div>
    ...
    editor.innerHTML = ""; //This doesn't work

    // Recalculate thread heights
    adjustThreadLineHeights();
    setupThreadReplyListeners();
  }
};

// Attach main post button functionality
document.querySelector("#cmnt-btn").addEventListener("click", postMainComment);

// Reply editor functionality
const setupThreadReplyListeners = () => {
  document.querySelectorAll(".thread-opener").forEach((button) => {
    button.addEventListener("click", (event) => {
        ...
        threadEditor1.innerHTML = `
                <img class="tec__avatar-preview thread-avatar" src="${imgTemplate}">
                  <div class="thread-editor-wrapper">
                    <textarea class="thread-editor"></textarea>
      ...
      // Handle post button
      const postButton = threadEditor.querySelector("#threadCmntBtn");
      postButton.onclick = () => {
        ...
        if (replyContent) {
          ...
          const replyTemplate = `
                  ...
                  <div class="cmnt-body-3rows">
                    ...
                    <div class="reply-msg">${replyContent}
                    </div>
                    <div class="main__engagement-opts engagement-opts">
                      <div class="vote-container">
                        <div class="uv-container">
                    ...
                    `;
          threadSection.insertAdjacentHTML("beforeend", replyTemplate);
          textarea.value = "";
          adjustThreadLineHeights();
        }
      };
      ...
      const handleOutsideClick = (e) => {
        if (!threadEditor.contains(e.target)) {
          threadEditor.remove();
...
//  This is the function for adjusting thread line height dynamically
